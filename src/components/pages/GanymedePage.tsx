...
import { DofusRelatedPages } from '../DofusRelatedPages'
    ...
    <div className="space-y-12">
      <section className="max-w-4xl mx-auto p-6">
        <Card className="bg-[#2a2a2a] text-[#e6d7c3] mb-6">
          ...
          <CardContent>
            <p className="mb-4">
              Primeiro, você precisa ter o Ganymede instalado para usar os
              guias.
            </p>
            <a
      ...
      <DofusRelatedPages currentPath="/jogos/dofus/ganymede" />
    </div>
  )
}
